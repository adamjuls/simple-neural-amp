...
run_name="devil_in_the_new_dress"
# dataset : need an input and output folder in this folder
# use relative path rooted at training/audio
audio_folder = "audio"
assert os.path.exists(audio_folder), "Audio folder  not found. Looked for " + audio_folder
# used to render example output during training (clean input example)
test_file = "audio/guitar.wav"
...
# Learning rate scheduler (ReduceLROnPlateau) without verbose param
